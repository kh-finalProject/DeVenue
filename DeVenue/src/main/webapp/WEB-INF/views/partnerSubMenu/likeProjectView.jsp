        ...
        <div class="col-md-2 mb-4 mt-5">
          ...
          <section id="sidebar_partner_profile">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <p>${like[0].partner.memNick}</p>
                    <p>${like[0].partner.memEmail}</p>
                </div>
            </div>
        ...
        <div class="col-md-6 mb-4 mt-5">
          ...
          <section id="projectList">
            ...
            <div class="mx-2" id="projectList_items">
            	...
            	<c:param name="id" value="${like.pList.id}"/>
            	<c:param name="page" value="${pi.currentPage}"/>
            	<c:param name="mCategory" value="${like.pList.mCategory}"/>
                              ...
                              <div class="row">
                                <div class="col-md-9">
                                  <div class="d-inline-block mb-2">
                                        <c:choose>
				                       	<c:when test="${like.pList.project.proRecruit eq 'Y'}">
				                       		<span class="badge badge-secondary">모집중</span>
				                       	</c:when>
				                       	<c:when test="${like.pList.project.proRecruit eq 'N'}">
				                       ...
				                       <fmt:formatDate value="${like.pList.project.proCreateDate}" pattern="yyyyMMdd" var="cdate"/>
                                  ...
                                  <h5 class="card-title"><a href="${pdetail}">${like.pList.project.proName}</a></h5>
                                  <table>
                                    <tr>
                                      <td><i class="fas fa-won-sign"></i>예상금액<strong>
                                      <fmt:setLocale value="ko"/><fmt:formatNumber value="${like.pList.project.proPayment}" type="currency"/>
                                      </strong>원</td>
                                      <td><i class="far fa-circle"></i>예상기간<strong>${like.pList.project.proDuration}</strong>일</td>
                                    </tr>
                                  </table>
                                  <table>
                                    <tr>
                                      <td><i class="far fa-circle"></i>${like.pList.mCategory}</td>
                                      <td><i class="far fa-circle"></i>${like.pList.dCategory}</td>
                                      <td><i class="fas fa-map-marker-alt"></i>${like.pList.project.proLocation}</td>
                                    </tr>
                                  </table>
                                </div>
                                <div class="col-md-3">
          ...
          <script>
          	...
          	$(document).on("click",".likeCancel",function(){
          		...
          		var likeId=$(this).parent().find("input[type='hidden']").val();
          		
          		$.ajax({
          			url:"deleteLikeProject.do",
          			data:{lId:likeId},
          			success:function(data){
          				location.href="likeProjectList.do?page="+${pi.currentPage};
          			},
