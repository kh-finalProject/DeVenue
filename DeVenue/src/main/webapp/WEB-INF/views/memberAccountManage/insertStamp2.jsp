...
<body onload="noBack();" onpageshow="if(event.persisted) noBack();" onunload="">
    ...
    <div class="allWrap">
        ...
        <div class="SsigUpload_content">
            ...
            <div class="wizard">
                <div class="wizard-inner" style="">
                    ...
                    <ul class="nav nav-tabs" role="tablist" style="">
                        ...
                        <li role="presentation" class="step step2 active">
            ...
            <!-- 각 단계 -->
            <form action="changeContrast.do" method="post" enctype="multipart/form-data" id="stampImgUploadForm">
                <!-- 2단계 영역 - 이미지 대비 조정 -->
                <div class="stamp_controll_area">
                    <table border="0"
                        style="width: 80%; margin: auto; margin-top: 30px; margin-bottom: 40px; font-size: 14px;">
                        <tr>
                            <td style="font-size: 15px; width: 110px;"><span style="color: orange;">*</span> 대비 조정</td>
                            <td style="padding-bottom: 0px;">
                                첨부한 이미지를 확인 후, 하단의 스크롤바를 움직여 가장 뚜렷하게 보이는 서명을 선택하세요.
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>
                                [다음 단계] 버튼을 클릭하면 잘라내기 단계로 이동합니다.
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                        ...
                        <tr>
                            ...
                            <td style="padding-top: 10px; padding-bottom: 0px !important; display: flex;">
                                <!-- 배경이 투명이면 안보이기 때문에, 백그라운드 지정 위함 -->
                                <div style="background-color: white; padding: 0px; margin: 0px; height: auto;">
                                    <img id="img_preview" src="${pageContext.servletContext.contextPath }/resources/sigImg/${renameFileName}" width="200px" height="200px" style="z-index: 999;">
                                </div>
                                ...
                                <input type="hidden" name="contrastPercent" id="contrastInput" value="0">
                                <input type="hidden" name="beforeFileName" id="beforeFileNameInput" value="${renameFileName }">
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>
                                <input type="range" id="rangeCont" step="1" min="0" max="50" value="0">
                            </td>
                        </tr>
                    </table>
                    <hr style="border-style: dashed; border-color: gray;">
...
<%-- 		    <a href="${pageContext.servletContext.contextPath }/resources/sigImg/${renameFileName}" download="도장이미지" style="color:white;">다운로드</a> --%>
            </form>
        </div>
    </div>
	<!-- 풋터 가져오기  -->
    ...
    <script>
        $(function () {
            // 스텝에 css 설정. 현재단계(active) 속성을 가지고 있는 것의 백그라운드 색이 같게
            ...
            $('#rangeCont').change(function(){
                ...
                // 콘트라스트 변경 수치를 input 태그에 담아줌
                $('#contrastInput').val($(this).val());
            })
        })
