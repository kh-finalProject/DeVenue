      ...
      <div class="col-2 text-white" style="border-right: 2px solid #2098d1; margin-right:40px; margin-left:70px; font-family: 'Jua', sans-serif;">
          ...
          <div style="padding-bottom: 5.5%;  " >
            ...
            <br>
              ...
              <div>
                <li  id ="mText" style ="color:white"><a href ="checkingProjectList.do"> 검수중인 프로젝트</a></li>
              </div>
              <br>
              <br>
              <br>
              <div>
                  <li id ="mText" style ="color:lightslategray"> <a href="temporaryStoreList.do" style ="color: white;">임시저장</a></li>
                   <br>
              ...
              <br>
              <div>
             <li  id ="btext" , style= "color:lightslategray"> <a href ="#" style ="color: #2098D1;">등록 실패</a></li>
                  <br>
        ...
        <div id= "explainbox" style ="padding:20px;">
            ...
            <li id ="sText">1. 검수 후 등록에 실패한 프로젝트의 목록입니다.<br>
