                        ...
                        <form id="application" method="post" action="submitApplication.do" enctype="multipart/form-data">
                                ...
                                <div class="nego price">
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="nego_price_input" type="text" class="form-control"
                                            placeholder="금액을 입력하세요." value="${app.aPayment}"
                            ...
                            <div class="mt-5 col-md-12">
                                ...
                                <div id="calendarDisplay">
                                    ...
                                    <label>기간</label><input id="duration" type="text" class="form-control" required name="aDuration" value="${app.aDuration}">
                                </div>
                                <script>
                            ...
                            <div class="mt-5 col-md-12" style="width: 100%;height: 10rem;">
                                ...
                                <div>
                                    <textarea id="apply_textarea" rows="10" class="form-control"
                                        style="width: 100%;" required name="aContent">${app.aContent}</textarea>
                                    <div id="textareaAppendix">'지원 내용이 파트너님의 첫인상에 큰 영향을 미칩니다."
                                    	<c:set var="content" value="${app.aContent}"/>
                                        <span id="apply_textCount"><strong>${fn:length(content)}</strong>자</span>
                                    </div>
                                </div>
                            </div>
                            <script>
                            ...
                            <div class="mt-5 mb-5 col-md-12" style="width:100%;">
                               ...
                               <!-- 임시저장된 포트폴리오가 있는지 여부에 따라 -->
                                <c:choose>
                                <c:when test="${not empty app.portfolio}">
                                
                                <script>
                                $(function(){
                                	$("#portfolioExist").attr("checked",true);
                                	$("#portfolio_upload_detail").css("display","block");
                                	
                                })
                                </script>
                                </c:when>
                                <c:when test="${empty app.portfolio}">
    
                                <script>
                                $(function(){
                                	$("#portfolioNotExist").attr("checked",true);
                                ...
                                <div class="row mt-5" id="portfolio_upload_detail">
                                    <div class="col-md-12">
                                                    ...
                                                    <table style="width: 100%; height: 100%;">
                                                        <tr>
                                                            <td class="align-middle preview">
                                                            	<c:if test="${empty app.portfolio[0] }">
                                            ...
                                            <div class="col-md-4">
                                                <div class="uploadBox">
                                                    <table style="width: 100%; height: 100%;">
                                                        <tr>
                                                            <td class="align-middle preview">
                                                                <c:if test="${empty app.portfolio[1] }">
                                                                <i class="fas fa-plus fa-2x ml-2"></i>
                                                            	</c:if>
                                            ...
                                            <div class="col-md-4">
                                                <div class="uploadBox">
                                                    <table style="width: 100%; height: 100%;">
                                                        <tr>
                                                            <td class="align-middle preview">
                                                                <c:if test="${empty app.portfolio[2] }">
                                                                <i class="fas fa-plus fa-2x ml-2"></i>
                                                            	</c:if>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div>
                                                    <textarea id="portfolio_describe_textarea" class="form-control"
                                                        rows="10" maxlength="2000" name="portContent"></textarea>
                            ...
                            <div class="mt-5 mb-5 col-md-12" style="width:100%;">
                                ...
                                <!-- 사전에 등록한 이력서가 있는지에 따라 -->
                                <c:choose>
                                <c:when test="${not empty app.originalResume}">
                                <script>
                                $(function(){
                                	$("#resumeExist").attr("checked",true);
                                	$("#resume_upload_detail").css("display","block");
                                })
                                </script>
                                </c:when>
                                <c:when test="${empty app.originalResume}">
                                <script>
                                $(function(){
                                	$("#resumeNotExist").attr("checked",true);
                                ...
                                <!--이력서 존재 시, 업로드 디테일 시작-->
                                <div class="row mt-5" id="resume_upload_detail">
                                    <div class="col-md-12">
                                        ...
                                        <div class="row mt-4" id="resume_upload">
                                            <div class="col-md-12">
                                            	...
                                            	<c:if test="${not empty app.originalResume}">
												<div>
												<label>제출한 이력서 확인</label>
												<a href="${contextPath}/resources/resume/${app.reNameResume}"
                                    							download="${app.originalResume}">${app.originalResume}</a>
                                    							
                                    			<p>이력서 갱신을 원하시면 새로운 이력서를 업로드 해주세요.</p>
												</div>
												</c:if>
