          ...
          <table width="533px"   >
              <thead>
                  ...
                  <tr style= "border-bottom:2px solid #2098d1" id ="sText" >
                      ...
                      <td><img src="money.png" width  ="20" style ="margin-left: 20px; padding-top:10px;  padding-bottom:10px;">  <span class="badge badge-secondary">예상금액    </span>
                    </td>
                      <td >2000000원&nbsp;&nbsp;&nbsp;</td>
                      <td ><img src ="period.png" width="20"> <span class="badge badge-secondary">예상기간   </span></td>
                      <td>30일&nbsp;&nbsp;&nbsp;</td>
                      <td><li><img src ="deadline.png" width="20"> <span class="badge badge-secondary">모집마감    </span></li></td>
                      <td><li style= "margin-right:15px;">2020년 2월 30일&nbsp;&nbsp;&nbsp;</li></td>
                 
                  </tr>
                  <tr >
                      <table  style= "border-bottom:2px solid #2098d1; " id ="sText" width="534px">
                          <tr  align ="center" style ="border-bottom:2px solid ; padding:1px; height:50px;" id ="sText">
                            
                              <td  style = " border-bottom:2px solid white;  " > <span class="badge badge-primary" style ="font-size:15px; padding:5px; margin-left:10px;  width:80px;">기획상태    </span></td>
                              <td  >서류</td>
                              <td  style = " border-bottom:2px solid white;  margin-left:10px;"><span class="badge badge-primary" style ="font-size:15px; padding:5px; margin-left:10px;  width:80px;">매니징 경험</span></td>
                              <td  >X</td>
                              <td  style = " border-bottom:2px solid white; padding:1px;" ><span class="badge badge-primary" style ="font-size:15px; padding:5px; margin-left:10px;  width:80px;">제출일자</span></td>
                              <td  >2020년 10월11일</td>
