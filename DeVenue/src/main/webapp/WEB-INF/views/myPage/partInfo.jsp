				...
				<div class="row">
					...
					<div class="col-12" style="margin-left: 5%; margin-top: 5%;">
						...
						<div class="col-12"
							...
							<div class="col-8"
								style="position: absolute; margin-left: 120px;">
								<span><i class="fa fa-keyboard-o"></i> <c:if
										test="${partInfo.mcId eq 'MC1'}">개발</c:if> <c:if
										test="${partInfo.mcId eq 'MC2'}">다지인</c:if> <c:if
										test="${partInfo.mcId eq 'MC3'}">개발 + 디자인</c:if> </span>
							</div>
						</div>
						<div class="col-12"
							style="width: 100%; height: 70px; position: relative;">
							<div class="col-2"
								style="width: 200px; position: absolute; text-align: right;">
								<label>* 선호프로젝트 형태<label>
							</div>
							<div class="col-10"
								style="position: absolute; margin-left: 120px;">
								<span id="workType"> <input type="hidden" id="wtId"
									value="${partInfo.wtId }"> <c:if
										test="${partInfo.wtId eq 'WT1'}">상주</c:if> <c:if
										test="${partInfo.wtId eq 'WT2'}">외주</c:if> <c:if
										test="${partInfo.wtId eq 'WT3'}">상주 + 외주</c:if>
								</span> <br>
								<p id="1">여</p>
						...
						<div class="col-12"
							style="width: 100%; height: 30px; position: relative; margin-top: 10px;">
							<div class="col-2" style="position: absolute; text-align: right;">
								<label>* 활동 가능성</label>
							</div>
							<div class="col-8"
