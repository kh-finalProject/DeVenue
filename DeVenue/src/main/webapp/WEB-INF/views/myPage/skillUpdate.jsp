		...
		<div class="container">
			...
			<div class="col-8 text-white" style="font-family: 'Jua', sans-serif;">
				...
				<div class="row">
					...
					<div class="col-12"
						style="margin-left: 5%; margin-top: 5%; border-bottom: 2px dashed white;">
						<p>
							<b>[ 보유 기술 입력 가이드]</b>
						<p>
							1. 보유 기술은 한 가지씩 입력해 주세요. Ex)C#, JavaScript, Android, Photoshop 등<br>
					...
					<form method="GET" action="skillInsert.do">
						...
						<div class="col-12" style="margin-left: 5%; margin-top: 2%;">
							<table class="table">
								...
								<!-- 기술 등록 -->
								<tr class="skillTr">
									<td class="skillName"><input type="text" name="skillName"
										style="width: 180px; height: 40px;"></td>
									<td class="skillLevel"><select name="level"
									...
									<td class="skillYear"><input type="text" name="skillYear"
										style="width: 180px; height: 40px;"></td>
								</tr>
							</table>
						</div>
						<div class="col-12"
							...
							<!-- tr 태그 만들기(기술 테이블 추가) -->
							<a href="skill.do" class="btn btn-info">취소</a>
