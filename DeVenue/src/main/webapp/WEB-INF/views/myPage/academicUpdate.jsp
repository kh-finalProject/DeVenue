		...
		<div class="container">
			...
			<div class="col-8 text-white" style="font-family: 'Jua', sans-serif; margin-left: 210px;">
				...
				<div class="row">
					...
					<div class="col-12"
						style="height: auto; margin-left: 5%; margin-top: 5%;">
						<table>
							<form method="GET" action="SSCareerUpdate.do">
								...
								<tr>
									<th class="table-secondary"
										style="width: 100px; padding: 10px;">분류</th>
									...
									<th class="table-secondary"
										style="width: 100px; padding: 10px;">상태</th>
									<td class="table-light" colspan="2"
										style="width: 300px; padding: 5px;"><select
								...
								<tr>
									<th class="table-secondary"
										style="width: 100px; padding: 10px;">학교명</th>
									<td class="table-light" colspan="2"
										style="width: 300px; padding: 5px;"><input type="text"
										name="school-name" style="width: 280px; height: 40px;">
									</td>
									<th class="table-secondary"
										style="width: 100px; padding: 10px;">전공</th>
									<td class="table-light" colspan="2"
										style="width: 300px; padding: 5px;"><input type="text"
										name="major" style="width: 280px; height: 40px;"></td>
								</tr>
								<tr>
									<th class="table-secondary"
										style="width: 100px; padding: 10px;">입학일</th>
									<td class="table-light" colspan="2"
										style="width: 300px; padding: 5px;"><select
										name="start-year" style="width: 120px; height: 40px;">
									...
									</select> <select name="start-month" style="width: 120px; height: 40px;">
									...
									<th class="table-secondary"
										style="width: 100px; padding: 10px;">졸업일</th>
									<td class="table-light" colspan="2"
										style="width: 300px; padding: 5px;"><select
										name="end-year" style="width: 120px; height: 40px;">
											<option value="year">년</option>
											<option value="2010">2010</option>
											<option value="2011">2011</option>
											<option value="2012">2012</option>
											...
											<option value="2019">2019</option>
											<option value="2020">2020</option>
									</select> <select name="end-month" style="width: 120px; height: 40px;">
											<option value="month">월</option>
											<option value="1">1</option>
											<option value="2">2</option>
											<option value="3">3</option>
								...
								<tr>
									<td colspan="5"
										style="width: 100%; height: 50px; text-align: right; margin-top: 10px;">
