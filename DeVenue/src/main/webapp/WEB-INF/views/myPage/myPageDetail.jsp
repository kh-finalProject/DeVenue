                ...
                <div class="col-2 text-white"
                    ...
                    <div class="partnes-img"
                        style="width: 90%; height: 150px; margin: auto;">
                        	<img src="${contextPath }/resources/images/test.png" style="width: 100%; height: 100%; border-radius: 50px 50px 50px 50px;">
                    </div>
                    <!-- 닉네임 -->
                        ...
                        <div class="col-12 content">
                            <div class="col-12 content-memberinfo">
                                <h2>
                                    ...
                                    <a href="PartnesInfo.html" class="btn btn-info" style="float: right; margin-top: 30px;">업데이트 하기</a>
                                </h2>
                                <h5 style="color: grey">
                                    <span>개발자</span>
                                    <span class="bar">|</span>
                                ...
                                <div class="col-6"
                                    ...
                                    <div class="col-12" style="height: 120px;">
                                        ...
                                        <div class="col-12" style="width: 100%;">
                                            <span style="font-size: 20px;">평균평점 <span>0.0</span> / 평가
                                                <span>0</span>개</span>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            <div class="col-7" style="text-align: left; display: inline-block;">
                            ...
                            <div class="col-12 partition">
                                <div class="col-12 page-title">
                                    <h4>자기소개
                                        <a href="Self-introduction.html" class="btn btn-info" style="float: right;">업데이트 하기</a>
                                    </h4>
                            ...
                            <div class="col-12 partition">
                                <div class="col-12 page-title">
                                    <h4 style="height: 50px;">포트폴리오
                                        <a href="#" class="btn btn-info" style="float: right;">업데이트 하기</a></h4>
                                    <!-- 하나의 포트폴리오 -->
                                    <div class="portfolio">
                                        <div class="port-img">
                                        ...
                                        <div class="port-title">
                                            <p><a href="#">1. 아아ㅏ아아아ㅏ아아아아아아아아아아아아ㅏ아아아아앙</a></p>
                                            <span>개발 - 어플리케이션</span>
                                        </div>
                                    </div>
                                    <!-- 하나의 포트폴리오 -->
                                    ...
                                    <div class="portfolio">
                                        ...
                                        <div class="port-title">
                                            <p><a href="#">2. 아아ㅏ아아아ㅏ아아아아아아아아아아아아ㅏ아아아아앙</a></p>
                                            <span>디자인 - 기타</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12 partition">
                                <div class="col-12 page-title">
                                    <h4 style="height: 50px;">경력
                                        <a href="#" class="btn btn-info" style="float: right;">업데이트 하기</a></h4>
                                    <div class="col-12 career-conatiner">
                                        <div class="col-12 career-inner">
                                            <div class="col-4 career-title"><b>회사명</b></div>
                                            <div class="col-10 career-content">어느 회사명?</div>
                                        </div>
                                        <div class="col-12 career-inner">
                                            <div class="col-4 career-title"><b>근무부서</b></div>
                                            <div class="col-10 career-content">어느 근무 부서?
                                            </div>
                                        </div>
                                        <div class="col-12 career-inner">
                                            <div class="col-4 career-title"><b>직위</b></div>
                                            <div class="col-10 career-content">어느 직위임?
                                            </div>
                                        </div>
                                        <div class="col-12 career-inner">
                                            <div class="col-4 career-title"><b>근무시간</b></div>
                                            <div class="col-10 career-content">2020년 02월 ~ 현재(6개월)
                                            </div>
                                        </div>
                                        <div class="col-12 career-inner">
                                            <div class="col-4 career-title"><b>설명</b></div>
                                    ...
                                    <div class="skill">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" readonly style="width: 190px; height: 40px;"
                                                        value="1등급"></td>
                                                <td><input type="text" readonly style="width: 190px; height: 40px;"
                                                        value="3년이상"></td>
                                            </tr>
