                ...
                <div class="col-8 text-white" style="font-family: 'Jua', sans-serif;">
                    ...
                    <div class="row">
                        <div class="col-12"
                            ...
                            <a href="mypagePortfolioAll.html" class="btn btn-info" style="float: right;">전체포트폴리오 보기</a>
                        </div>
                        <div class="col-12" style="margin-left: 5%; margin-top: 5%;">
                            <h3>경력
                                <a href="careerUpdate.do" class="btn btn-info" style="float: right;">추가하기</a>
                            </h3>
                        </div>
                        <div class="col-12" style="margin-left: 5%; margin-top: 2%;">
                            <div class="col-12 career-conatiner">
                                <div class="col-12 career-inner">
                                    ...
                                    <div class="col-10 career-content">어느 회사명?
                                        <div class="col-9" style="display: inline-block; text-align: right;">
                                ...
                                <div class="col-12 career-inner">
                                    ...
                                    <div class="col-10 career-content"><p>설명란</p>
                                    </div>
                                </div>
                            </div>
                        </div>
