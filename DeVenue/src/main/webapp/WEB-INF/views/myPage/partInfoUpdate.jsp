					...
					<div class="col-12">
						<form method="GET" action="partInfoUp.do">
							...
							<div class="col-12"
								...
								<div class="col-3"
									style="position: absolute; margin-left: 5%; text-align: right;">
									<span>* 직종</span>
								</div>
							...
							<div class="col-12"
								...
								<div class="col-9"
									style="width: 100%; position: absolute; margin-left: 30%;">
							...
							<div class="col-12"
								style="margin-left: 5%; height: 80px; position: relative;">
								<div class="col-3"
									style="position: absolute; margin-left: 5%; text-align: right;">
									<span>* 활동 가능성</span>
								</div>
