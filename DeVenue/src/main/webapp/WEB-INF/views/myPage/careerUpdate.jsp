					...
					<div class="col-12">
						<form method="GET" action="careerInsert.do">
							...
							<div class="col-12"
								...
								<div class="col-4"
									style="position: absolute; margin-left: 5%; font-size: 20px;">
							...
							<div class="col-12"
								...
								<div class="col-4" style="position: absolute; margin-left: 20%;">
									<input type="text" id="company-department"
										name="company-department" style="width: 400px; height: 40px;">
								</div>
							</div>
							<div class="col-12"
								style="margin-left: 5%; height: 20px; margin-top: 5%; position: relative;">
								...
								<div class="col-4" style="position: absolute; margin-left: 20%;">
									<input type="text" id="company-position"
										name="company-position" style="width: 400px; height: 40px;">
								</div>
							</div>
							<div class="col-12"
								...
								<div class="col-10"
									...
									</select> <select name="start-month" style="width: 150px; height: 40px;">
							...
							<div class="col-12 end-date"
								...
								<div class="col-10"
									...
									<select name="end-year" style="width: 150px; height: 40px;">
										...
										<option value="2019">2019</option>
										<option value="2020">2020</option>
									</select> <select name="end-month" style="width: 150px; height: 40px;">
							...
							<div class="col-12"
								style="margin-left: 5%; height: 300px; margin-top: 5%; position: relative;">
								<div class="col-4"
									style="position: absolute; margin-left: 5%; font-size: 20px;">
